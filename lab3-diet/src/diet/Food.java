...
public class Food {
	...
	private TreeMap<String,NutritionalElement> menus = new TreeMap<String,NutritionalElement>();
	...
	public void defineRawMaterial(String name, double calories, double proteins, double carbs, double fat) {
		NutritionalElement rawMaterial = new RawMaterial(
				name,
				calories,
				proteins,
				carbs, 
	...
	public void defineProduct(String name, double calories, double proteins, double carbs, double fat) {
		NutritionalElement product = new Product(
				name,
				calories,
				proteins,
				carbs, 
